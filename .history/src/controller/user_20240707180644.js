...
async function update(req, res) {
  try {
    ...
    if (Number.isInteger(Number.parseInt(paramsId)))
      return res
        .status(httpStatus.BAD_REQUEST)
        .send(`Number.isInteger(Number.parseInt(paramsId)) ${Number.isInteger(Number.parseInt(paramsId))} Id enviado na requisição é inválido`)
