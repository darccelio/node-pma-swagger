...
// router.get('/', (req, res) => {
//     // #swagger.tags = ['User']
//     // #swagger.description = 'Endpoint tessssssssssss que retorna todos os usuários'
//     res.send("Returning users");
// })

// router.post('/', (req, res) => {
//     // #swagger.tags = ['User']
//     // #swagger.description = 'Endpoint tesssssssssssstesssssssssssstesssssssssssstesssssssssssstesssssssssssstessssssssssssque cria um novo usuário'
